...
| L9 | Environmental/planning advice liability from customer-facing wording | MEDIUM | Low today | MITIGATED | Zero occurrences of the flagged phrases; `insights.py` refuses to narrate noise | Re-audit when a landing page or pricing page exists |
